...
public class BadgeView extends TextView {
	...
	public BadgeView(Context context, View target,View parent) {
		 this(context, null, android.R.attr.textViewStyle, target, 0,parent);
	}
	...
	public BadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex,View parent) {
		super(context, attrs, defStyle);
		init(context, target, tabIndex,parent);
	}
